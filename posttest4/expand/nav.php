    ...
    <header>
        <nav class="navbar">
            ...
            <menu class="menu-navbar">
                <ul>
                    <li>
                        <a class="navbar-link" id="active" href="index.html#home"><b>Home</b></a>
                    </li>
                </ul>
                <ul>
                    <li>
                        <a class="navbar-link" href="index.html#merchandise"><b>Merchandise</b></a>
                    </li>
                </ul>
                <ul>
                    <li>
                        <a class="navbar-link" href="index.html#about"><b>About Me</b></a>
                    </li>
                </ul>
            </menu>
            ...
            <div class="buy-ham-toggle">
                ...
                <div class="user">
                    <a href="daftar.php"><i class="fa-solid fa-user fa-2xl" style="color: #ffffff;"></i></a>
                </div>
                <div class="ham">
